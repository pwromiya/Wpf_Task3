...
public partial class MainWindow : Window
{
    ...
    private async void BtnLoadCsv_Click(object sender, RoutedEventArgs e)
    {
        ...
        int progressStep = 10000; // update UI every 10k rows
        int processed = 0;
        ...
        try
        {
            ...
            using (var reader = new StreamReader(path))
            {
                ...
                while ((line = await reader.ReadLineAsync()) != null)
                {
                    ...
                    if (processed % progressStep == 0)
                    {
                        ...
                        ProgressText.Text = $"Loading: {percent}% ({processed}/{totalLines})";
                    }
            ...
            ProgressText.Text = $"Completed: {processed} records loaded.";
